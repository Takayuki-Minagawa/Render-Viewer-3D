...
import type { ZipPreflightLimits } from "./zip-preflight";
...
export async function inspectThreeMFPackage(
  data: ArrayBuffer,
  modelEntry: string,
...
export function resolveThreeMFUnit(
...
export function assertRequiredThreeMFEntries(
