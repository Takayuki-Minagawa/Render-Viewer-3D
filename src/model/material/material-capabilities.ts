...
const POV_CAPABILITIES: MaterialCapabilityModel[] = [
  ...
  capability("pov.finish.diffuse", "pov.texture.finish.diffuse", "finish", "stored-only", "diffuse / backside", "Diffuse / backside", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["拡散", "裏面", "brilliance"], ["diffuse", "backside", "brilliance"]),
  capability("pov.finish.diffuse-albedo", "pov.texture.finish.diffuseAlbedo", "finish", "stored-only", "diffuse albedo", "Diffuse albedo", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["拡散", "アルベド"], ["diffuse", "albedo"]),
  ...
  capability("pov.finish.phong-albedo", "pov.texture.finish.phongAlbedo", "finish", "stored-only", "phong albedo", "Phong albedo", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["フォン", "アルベド"], ["phong", "albedo"]),
  capability("pov.finish.specular-albedo", "pov.texture.finish.specularAlbedo", "finish", "stored-only", "specular albedo", "Specular albedo", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["鏡面", "アルベド"], ["specular", "albedo"]),
  ...
  capability("pov.media.density", "pov.interior.media.density", "media", "stored-only", "density", "Density", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["密度", "媒体"], ["density", "media"]),
  capability("pov.media.density-color-map", "pov.interior.media.*.density.*.colorMap", "media", "stored-only", "density color_map", "Density color map", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["密度", "カラーマップ"], ["density", "color map"]),
  capability("pov.media.density-map", "pov.interior.media.*.density.*.densityMap", "media", "stored-only", "density_map", "Density map", "POV-Rayの構造と値を保持します。現在のWebGLプレビューには反映されません。", "Stores the POV-Ray structure and values; the current WebGL preview does not render this feature.", ["密度", "再帰", "密度マップ"], ["density", "recursive", "density map"]),
